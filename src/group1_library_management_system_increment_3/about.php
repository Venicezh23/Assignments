...
<body>
    ...
    <div id="myModalHelp" class="modal">
        ...
        <ul class="nav justify-content-center header">
            ...
            <li class="nav-item">
                <a class="nav-link active header-text" href="about.php" style="color: #00c2cb;background-color: #ffffff;">About</a>
            </li>
        </ul>
	...
	<div class="desc_map">
        <div>
            <div class="your-one-way-stop-to-academic-excellence">
                Your One Way Stop to Academic Excellence
            </div>
            <div class="about-description">
            At the University of Southampton Malaysia, our library is more than just a repository of books; 
            it&#39;s a vibrant hub of knowledge and learning. 
            Catering to the diverse needs of our students and staff, we offer a comprehensive collection 
            of materials spanning various disciplines, including engineering, business, and computer science. 
            Our commitment to excellence ensures that every resource within our library is of 
            the highest quality, fostering a conducive environment for academic exploration and personal growth.
            </div>
            <div class="opening-description">
                Opening hours are: <b><?= date('H:i', strtotime($_SESSION['StartTime'])) ?> - <?= date('H:i', strtotime($_SESSION['EndTime'])) ?></b>
            </div>
        </div>
        <img class="map-about" src="https://www.southamptonmalaysia.edu.my/sites/default/files/node/new-campus-gallery-image/images/2021-12/_16A3405.jpg">
	</div>
    
    
    <div class="desc_map">
        <iframe class="map-about" src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2561.4809955648416!2d103.61651912002698!3d1.440441642970935!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x31da0b093c771a1f%3A0x4bdbd9c5703b646a!2sUniversity%20of%20Southampton%20Malaysia%20(Southampton%20Malaysia)!5e0!3m2!1sen!2smy!4v1713890889451!5m2!1sen!2smy" width="600" height="450" style="border:0;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>    
        <div>
            ...
            <div class="about-description">
                <b>Address:</b><br>
                3, Eko Galleria, C0301, C0302, C0401, Blok C, Taman, Persiaran Eko Botani, 79100 Iskandar Puteri, Johor
            </div>
        </div>
    </div>
