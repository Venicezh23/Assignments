...
<body>
    ...
    <div id="myModalHelp" class="modal">
        ...
        <ul class="nav justify-content-center header">
            <li class="nav-item">
                <a class="nav-link active header-text" href="homepage.php" style="color: #00c2cb;background-color: #ffffff;">Home</a>
            </li>
            <li class="nav-item">
        ...
        <div class="rounded mx-auto d-block infoaboutlibrary">
            <div class="gradient-mask"></div>
            <div class="librarybox">
                <div class="big-title">Our Library</div>
                <div class="small-title">A central hub for academic resources, services, and collaborative spaces supporting research and learning</div>
                <a href="about.php">
                    <button class="learnmorebutton" id="learnMoreButton">Learn More</button>
                </a>
            </div>
            <img class="library-image" src="https://www.southamptonmalaysia.edu.my/sites/default/files/node/new-campus-gallery-image/images/2021-12/_16A3435_0.jpg" id="28:171"/>
        </div> 
        ...
        <div class="group-available-books">
            <div class="availablebooks ">
                <nav class="navbar" style="background-color: #ffffff;" >
                    <div class="container-fluid" >
                        <a class="navbar-brand available-books-text">Available Books</a>
                        <form class="d-flex" >
                            <a class="d-flex justify-content-end see-all-button" href="bookpage.php">See All</a>
                        </form>
                    </div>
                </nav>
                ...
                <div class="book-box">
                    <?php
                        $select_books = $conn->prepare("SELECT DISTINCT `book`.`Title`, GROUP_CONCAT(`author`.Name) AS `Authors`, `book`.`Image` FROM `book` JOIN `author` ON `book`.`BookID` = `author`.`BookID` GROUP BY `book`.`BookID`LIMIT 7;");
                    ...
                    <div class="book">
                        <?php if($fetch_book['Image'] != ''){ ?>
                            <img src="<?= $fetch_book['Image']; ?>" alt="" title="<?= $fetch_book['Title']; ?>" class="image-book">
                        <?php }else{ ?>
                        ...
                        <div class="group-title-author">
                            ...
                            <div class="book-text"><?= $fetch_book['Title']; ?></div>
                        </div>
                    </div>
            ...
            <div class="studentInUosm">Student in UoSM</div>

            <div class="quotepage">
                <div class="image-with-text">
                    <img class="quote-pic" src="https://img.freepik.com/free-photo/woman-shirt-reading-book_171337-14125.jpg?t=st=1713156307~exp=1713159907~hmac=825035482027e302a1bdbaaa897bd9c363742433a18222b4c53cce5e8f7ee59a&w=996">
                    <div class="quote-text">&#34;The UoSM library has been an invaluable resource, providing everything from comprehensive research materials to quiet study spaces, making my academic journey not only manageable but truly enriching.&#34; - Lisa (Phd Student)</div>
                </div>
                <div class="image-with-text">
                    <img class="quote-pic" src="https://img.freepik.com/free-photo/portrait-smiling-male-student-holding-books_171337-9123.jpg?t=st=1713156366~exp=1713159966~hmac=a49e698d469ff33dc0aeb658db67bb04a13c365075739c1980d1a9e6817cc02b&w=996">
                    <div class="quote-text">&#34;The UoSM library has exceeded my expectations with its extensive  collection, helpful staff, and conducive environment, allowing me to  delve deep into my studies and excel academically.&#34; - Adam (Eng Student)</div>
                </div>
                <div class="image-with-text">
                    <img class="quote-pic" src="https://img.freepik.com/free-photo/university-study-abroad-lifestyle-concept-satisfied-happy-asian-male-student-glasses-shirt-showing-thumbs-up-approval-likes-studying-college-holding-laptop-backpack_1258-55849.jpg?t=st=1713155735~exp=1713159335~hmac=bd7563fb1f42ad916e292f6452495fa9c64fd3836b3eb0701f4774d6eba3801c&w=996">
                    <div class="quote-text">&#34;The UoSM library has been an indispensable sanctuary for me during my academic journey. From its extensive collection of resources to its tranquil study spaces, the library has provided me with the perfect environment to delve into my studies and excel academically.&#34; - Alex (CS Student)</div>
                </div>
            </div>
        </div>
    ...
    <script>
        ...
        function carousel() {
        var i;
        var x = document.getElementsByClassName("image-with-text");
