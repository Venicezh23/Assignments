                    ...
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <form action="" method="GET" class="search-form">
                            <div class="d-flex align-items-center">
                                ...
                                <a href="book_database_group.php">
                                    <i class="fa-solid fa-boxes-stacked fa-xl" style="color:#002439; margin:20px;"></i>
                                </a>
                            </div>
                        </form>
                                        ...
                                        <tr>
                                            <td style="display:flex;padding-top:60px;">
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <form class="archive-form" action="archive_book.php" method="post">
                                                        <input type="hidden" name="bookid" value="<?= $fetch_book['BookID']; ?>">
                                        ...
                                        <tr>
                                            <td style="display:flex;padding-top:60px;">
                                                ...
                                                <?php } else { ?>
                                                    ...
                                                    <form class="unarchive-form" action="unarchive_book.php" method="post">
                                                        <input type="hidden" name="bookid" value="<?= $fetch_book['BookID']; ?>">
                                                        <button type="button" class="unarchive-button table-button" data-bookid="<?= $fetch_book['BookID']; ?>"><i class="fa-solid fa-folder"></i></button>
                                                    </form>
                                                <?php } ?>
                                            </td>
                                            <td><?= $fetch_book['BookID']; ?></td>
    ...
    <script>
        $(document).ready(function() {
            $('.dropdown-item').click(function() {
                ...
                if (filter != "All Books") {
                    var href = 'book_database.php?filter=' + encodeURIComponent(filter); 
                    window.location.href = href; // Redirect to the new link
                } else{
                    var href = 'book_database.php'
                    window.location.href = href; // Redirect to the new link
                }
            });
        });
