    ...
    <div class="container-xxl position-relative bg-white d-flex p-0">
        ...
        <div class="sidebar">
            <nav class="navbar">
                ...
                <div class="navbar-nav w-100">    
                    ...
                    <a href="admin_links.php" class="nav-item nav-link active"><i class="fa-solid fa-link me-2"></i>Library Link</a>
        ...
        <div class="content">
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 header-graph-text">Patron</h6>
                    </div>
                    ...
                    <tbody>
                        <tr>
                            <td>Homepage</td>
                            <td><a class="linkBtn" href="homepage.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Bookpage</td>
                            <td><a class="linkBtn" href="bookpage.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>History</td>
                            <td><a class="linkBtn" href="history.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Contact</td>
                            <td><a class="linkBtn" href="contact.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>About</td>
                            <td><a class="linkBtn" href="about.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Fine Homepage</td>
                            <td><a class="linkBtn" href="pay-homepage.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Profile</td>
                            <td><a class="linkBtn" href="pay-homepage.php" target="_blank">Open</a></td>
            ...
            <div class="container-fluid pt-4 px-4">
                <div class="bg-light text-center rounded p-4">
                    <div class="d-flex align-items-center justify-content-between mb-4">
                        <h6 class="mb-0 header-graph-text">Librarian</h6>
                    </div>
                    ...
                    <tbody>
                        <tr>
                            <td>Dashboard</td>
                            <td><a class="linkBtn" href="dashboard.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Patrons Data</td>
                            <td><a class="linkBtn" href="user_database.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Books Data</td>
                            <td><a class="linkBtn" href="book_database.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Issue Data</td>
                            <td><a class="linkBtn" href="borrow.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Reserve Data</td>
                            <td><a class="linkBtn" href="reserve.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Fine Data</td>
                            <td><a class="linkBtn" href="fine_database.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Setting</td>
                            <td><a class="linkBtn" href="setting.php" target="_blank">Open</a></td>
                        </tr>
                        <tr>
                            <td>Profile</td>
                            <td><a class="linkBtn" href="profile_librarian.php" target="_blank">Open</a></td>
                        </tr>
                    </tbody>
                    </table>
                    </div>
