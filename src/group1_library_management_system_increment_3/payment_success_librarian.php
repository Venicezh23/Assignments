...
$stmt->bind_param("i", $_SESSION['patronID']);
...
<script>
    ...
    setTimeout(function() {
        window.location.href = 'fine_database.php';
...
<?php
	...
	$userStmt->bind_param("i", $_SESSION['patronID']);
	$userStmt->execute();
  $logMessage = "[" . date('Y-m-d H:i:s') . "] Librarian ID: " . $_SESSION['ID'] . " have paid " . $_SESSION['patronID'] . "'s fines.";
