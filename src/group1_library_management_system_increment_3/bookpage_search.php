<?php
    ...
    // Check if the 'search' parameter is empty, if so, redirect to bookpage.php
            ...
            <div class="availablebooks" id="searchBook" >
                ...
                <?php
                    if(isset($_GET['search'])){
                        ...
                        ?>
                            <div class="book">
                                <?php if($fetch_books['Image'] != ''){ ?>
                                    <form action="book_details.php" method="post">
                                        <input type="hidden" name="bookid" value="<?= $fetch_books['BookID']; ?>">
                                        <input type="hidden" name="image" value="<?= $fetch_books['Image']; ?>">
                                        <input type="hidden" name="title" value="<?= htmlspecialchars($fetch_books['Title']); ?>">
                                        <input type="hidden" name="author" value="<?= $fetch_books['Authors']; ?>">
                                        <input type="hidden" name="isbn" value="<?= $fetch_books['ISBN']; ?>">
                                        <input type="hidden" name="publisher" value="<?= $fetch_books['PublisherName']; ?>">
                                        <input type="hidden" name="year" value="<?= $fetch_books['PublishedYear']; ?>">
                                        <input type="hidden" name="category" value="<?= $fetch_books['Category']; ?>">
                                        <input type="hidden" name="edition" value="<?= $fetch_books['Edition']; ?>">
                                        <button type="submit" style="background-color:transparent;border:none;">
                                            <img src="<?= $fetch_books['Image']; ?>" alt="" title="<?= htmlspecialchars($fetch_books['Title']); ?>" class="image-book">
                                        </button>
                                    </form>
                                <?php }else{ ?>
                                ...
                                <div class="group-title-author">
                                    <div class="author-text"><?= $fetch_books['Authors']; ?></div>
                                    <div class="book-text"><?= htmlspecialchars($fetch_books['Title']); ?></div>
                                </div>
                            </div>
                            <?php
                            }
                            ...
                            ?>
                            <div class="book-box available-books-text">
